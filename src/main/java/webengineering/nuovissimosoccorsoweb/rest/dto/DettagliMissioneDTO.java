...
/**
 * DTO per i dettagli completi di una missione. Include operatori, mezzi,
...
public class DettagliMissioneDTO {
    ...
    public List<OperatoreAssegnatoDTO> getOperatori() {
        return operatori;
    }

    public void setOperatori(List<OperatoreAssegnatoDTO> operatori) {
        this.operatori = operatori;
    }

    public List<MezzoAssegnatoDTO> getMezzi() {
        return mezzi;
    }

    public void setMezzi(List<MezzoAssegnatoDTO> mezzi) {
        this.mezzi = mezzi;
    }

    public List<MaterialeAssegnatoDTO> getMateriali() {
        return materiali;
    }

    public void setMateriali(List<MaterialeAssegnatoDTO> materiali) {
    ...
    public ValutazioneMissioneDTO getValutazione() {
        return valutazione;
    }

    public void setValutazione(ValutazioneMissioneDTO valutazione) {
