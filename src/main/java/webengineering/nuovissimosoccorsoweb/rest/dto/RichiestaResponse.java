...
public class RichiestaResponse {
    ...
    public RichiestaResponse(boolean success, String message) {
        this.success = success;
        this.message = message;
        this.richiesta = null;
    }
    
    public RichiestaResponse(boolean success, String message, RichiestaDTO richiesta) {
        this.success = success;
        this.message = message;
